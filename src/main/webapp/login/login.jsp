                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="${path}/login/loginaction" method="post" class="login-form" id="loginForm">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="username" placeholder="请输入用户名..." value="${username}" class="form-username form-control" required id="form-username">
                            </div>
                            <div class="form-group">
                                <label class="sr-only" for="form-password">Password</label>
                                <input type="password" name="password" placeholder="请输入密码..." value="${password}" class="form-password form-control" required id="form-password">
                            </div>
                            <div class="form-group">
                                <%--<label class="sr-only" for="form-code">Code</label>--%>
                                <img id="captchaImage" style="width: 105px; height: 48px" onclick="ChangeYZM()" class="captchaImage" src="${path}/login/getYZM">
                                <input style="width: 289px;height: 50px;border:3px solid #ddd;border-radius: 4px;" required type="test" name="enCode" id="form-code">
                            </div>
                            <script>
                                function ChangeYZM() {
                                    var yzm = document.getElementById("captchaImage");
                                    yzm.src = "${path}/login/getYZM?num=" + Math.random();
                                }
                            </script>
